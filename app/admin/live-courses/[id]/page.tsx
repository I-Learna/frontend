...
import { getAdminLiveCoursesDetails } from "@/services/adminServices";
...
const Page: FC<PageProps> = async ({ params }) => {
  const liveCoursedetails = await getAdminLiveCoursesDetails();
    ...
    <main className="p-4">
      <div className="max-w-3xl m-auto">
        ...
        <div className="space-y-6">
          {liveCoursedetails.modules.map((module) => (
