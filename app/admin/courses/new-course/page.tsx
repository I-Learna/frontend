...
const Page = () => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-semibold mb-4">Create Recorded Course</h2>
      <section className="space-y-5 max-w-3xl m-auto bg-gray-50 p-5 rounded-lg">
        <FormProvider {...formMethods}>
          ...
          <InputFile
            name="image"
            label="Upload Course Overview (Optional)"
            accept=".pdf, .doc, .docx, .RTF"
            placeholder="Click to upload"
            helperText="Add a short video introducing the course (MP4, Max size: 200 MB)."
          />

          <button className="btn btn-accent block ml-auto w-full">Submit for review</button>
        </FormProvider>
      </section>
    </div>
  );
